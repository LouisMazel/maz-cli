...
module.exports = async ({ outDir, allinfos }) => {
  ...
  const files = [
    `${process.env.PWD}/${appProjectName}/package.json`,
    `${process.env.PWD}/${appProjectName}/config/index.js`,
    `${process.env.PWD}/${appProjectName}/assets/scss/_override-maz-ui-vars.scss`
  ]
