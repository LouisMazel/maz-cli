...
module.exports = async ({ outDir, allinfos }) => {
  ...
  const files = [
    path.resolve(__dirname, `../${appProjectName}/package.json`),
    path.resolve(__dirname, `../${appProjectName}/config/index.js`),
    path.resolve(__dirname, `../${appProjectName}/assets/scss/_override-maz-ui-vars.scss`)
  ]
