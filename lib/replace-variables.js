...
module.exports = async ({ outDir, projectInfos }) => {
  const {
    appName,
    appEmail,
    appAuthor,
  ...
  const replaceOptions = {
    files: [`../${appProjectName}/package.json`, `../${appProjectName}/config/index.js`, `../${appProjectName}/assets/_override-maz-ui-vars.scss`],
    replaces: [
      {
        from: /<%APP_NAME%>/g,
        to: appProjectName
